...
(function() {
	...
	cusMap.prototype = {
		addCusInfoWindow: function(map) {
			...
			var myLatLng={lat: 37.5669756, lng: 126.9891145};
			...
			var content = '<div id="iw-container">' +
			                    ...
			                    '<div class="iw-content">' +
			                      ...
			                      '<img src="img/ltower.png" alt="ltower" height="115" width="83">' +
		...
		setData: function(mapDataset) {
			...
			for(var i = 0; i < mapDataset.data.length; i++) {
				...
				if (!mapDataset.data[i].docUid) continue;
