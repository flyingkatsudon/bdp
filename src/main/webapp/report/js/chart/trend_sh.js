/*
 * trend_sh.js
 * - insight report trend chart for SH, LC
 *
 * 
 * 18.09
 *
		...
		setData: function(ajaxData) {
			...
			for (var i = 0; i < d.length; i++) {
				...
				if (d[i].rn == 1) {
					...
					e[curDate][d[i].kwdA][0][2] = d[i].posPercent || "0";
					e[curDate][d[i].kwdA][1][1] = d[i].negCntBoth;
					e[curDate][d[i].kwdA][1][2] = d[i].negPercent || "0";
					e[curDate][d[i].kwdA][2][1] = d[i].neuCntBoth;
					e[curDate][d[i].kwdA][2][2] = d[i].neuPercent || "0";
					*/
